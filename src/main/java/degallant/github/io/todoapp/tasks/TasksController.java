...
public class TasksController {
    ...
    public ResponseEntity<?> list(
            //TODO standardize errors generated by invalid values either on request body or url params
            @RequestParam(name = "p", defaultValue = "1") int pageNumber,
            @RequestParam(name = "s", required = false) @Size(min = 1, message = "{validation.notempty.message}") String sort,
            @RequestParam(required = false) @Size(min = 1, message = "{validation.notempty.message}") String title,
            @RequestParam(name = "due_date", required = false) @Pattern(regexp = "^[12]\\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01])$", message = "{validation.date.message}") String dueDate,
